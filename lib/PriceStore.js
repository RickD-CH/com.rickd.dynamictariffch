...
class PriceStore {
  ...
  /** Anteil (0..1) der erwarteten Slots des lokalen Kalendertags von `day`, die einen Wert haben. */
  dayCoverage(day) {
   ...
   * `ratio` erlaubt Toleranz (z. B. 0.95), falls einzelne Slots dauerhaft fehlen -
   * Standard 1 (exakt) entspricht dem bisherigen Verhalten.
   */
  hasFullDay(day, { ratio = 1 } = {}) {
    return this.dayCoverage(day) >= ratio;
  }
